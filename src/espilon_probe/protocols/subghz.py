...
Shape: PACKET (radio) (see docs/protocols/subghz.md). Unlike JTAG/SPI this IS a radio, so all
...
# 8-byte pseudo-header (docs/protocols/subghz.md section 4), all multi-byte LE:
